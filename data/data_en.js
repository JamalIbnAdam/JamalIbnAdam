window.FamilyTreeData = {
    ...
    translations: {
        ...
        fadl_node: "52. Fadl bin Abdullah<br><span style=\"font-size:0.85rem; font-weight:500;\">(Estimated: 990 - 1030 AH)</span>",
        modern_era_title: "Modern Extension (1100 AH - 1447 AH)",
        ...
        branch_1_desc:
            "The Five Clans (Gen 53-54): Al-Sawalim, Al-Kadawi, Al-Allawi, Al-Bakoor, Al-Wasfa (~1070 AH). Followed by 20 generations down to you.",
        ...
        branch_3_desc: "Branches (Gen 53): Awlad Al-Akhdari, Awlad Yusuf (~1050 AH).",

        branch_4_title: "(4) Children of Qasim",
        branch_4_subtitle: "Zawiyat Brak",
        branch_4_desc: "Title: House of Judge Al-Rashid (~1060 AH).",

        branch_5_title: "(5) Al-Athamnah",
        branch_5_subtitle: "Zawiyat Brak",
        branch_5_desc: "Branches: Al-Baradnah (Sons of Badr al-Din ~1040 AH).",

        branch_6_title: "(6) Children of Abdul Wahid",
        branch_6_subtitle: "Zawiyat Brak",
        branch_6_desc: "Branches: Al-Alawneh (~1040 AH).",
        ...
        lib_logic_text:
            "1. <strong>Title:</strong> His name appears in manuscripts as 'Al-Sulami Al-Ansari'.<br>2. <strong>Script:</strong> Old documents written in Andalusian script.<br>3. <strong>Timeline:</strong> Perfect alignment with the exodus of Granadan families (post 897 AH).",

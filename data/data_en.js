window.FamilyTreeData = {
    meta: { lang: "en", dir: "ltr", dateFormat: "YYYY-MM-DD" },
    i18n: { search_placeholder: "Search...", born: "Born", died: "Died" },
    translations: {
        // Page
        page_title: "The Golden Record: History & Documentation of Al-Sabal Al-Ain",

        // Header
        header_title: "The Golden Record of Al-Sabal Al-Ain",
        header_subtitle: "From Yathrib to Wadi Al-Shatii: A 1000-Year Journey (73 Generations)",
        ...
        filter_all: "All",
        filter_yemen: "Yemen",
        filter_prophet: "Prophetic Era",
        filter_andalus: "Andalus",
        filter_migration: "Migration",
        filter_libya: "Libya",
        ...
        modern_era_detail:
            "According to family documentation: the gap between the founding ancestor (Gen. 51) and the current generation is 22 names. (Fadl and Salem) are mentioned above, leaving 20 generations representing the timeline up to our era.",
        ...
        lib_logic_text:
            "1. <strong>Title:</strong> His name appears in manuscripts as 'Al-Sulami Al-Ansari'.<br>2. <strong>Script:</strong> Old documents written in Andalusian script.<br>3. <strong>Timeline:</strong> Perfect alignment with the exodus of Granadan families (post 897 AH <span class=\"gregorian-date\">(1492 AD)</span>).",
        ...
        modal_story_label: "Historical Biography",
        modal_source_label: "Documentation Source",
    ...
    nodes: [
        ...
        },
        {
            ...
            type: "epoch-2",
            date: "Martyred 3 AH <span class=\"gregorian-date\">(625 AD)</span>",
        ...
        },
        {
            ...
            type: "epoch-2",
            date: "Died 78 AH <span class=\"gregorian-date\">(698 AD)</span>",
        ...
        },
        {
            ...
            type: "epoch-4",
            date: "860 - 930 AH <span class=\"gregorian-date\">(1456 - 1524 AD)</span> (estimated)",
            badge: "Andalusian مهاجر",
            src: "Family documents + Andalusian migration context",
            logic: "Witnessed Granada's fall (897 AH <span class=\"gregorian-date\">(1492 AD)</span>) and moved the family to Fez.",
        ...
        },
        {
            ...
            type: "epoch-5",
            date: "900 - 960 AH <span class=\"gregorian-date\">(1495 - 1553 AD)</span> (entered Fezzan ~950 AH <span class=\"gregorian-date\">(~1544 AD)</span>)",
            badge: "Waqf founder",
            src: "Tarikh Fezzan + waqf documents",
            logic: "Born in Morocco, migrated to Libya around 950 AH <span class=\"gregorian-date\">(~1544 AD)</span>, and established the waqf.",

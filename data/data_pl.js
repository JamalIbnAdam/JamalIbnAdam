window.FamilyTreeData = {
    ...
    translations: {
        ...
        fadl_node: "52. Fadl bin Abdullah<br><span style=\"font-size:0.85rem; font-weight:500;\">(Szacunkowo: 990 - 1030 AH)</span>",
        modern_era_title: "Współczesne Rozszerzenie (1100 AH - 1447 AH)",
        ...
        branch_1_desc: "Pięć Klanów (Gen 53-54): Al-Sawalim, Al-Kadawi, Al-Allawi, Al-Bakoor, Al-Wasfa (~1070 AH).",
        ...
        branch_3_desc: "Gałęzie (Gen 53): Awlad Al-Akhdari, Awlad Yusuf (~1050 AH).",

        branch_4_title: "(4) Dzieci Qasima",
        branch_4_subtitle: "Zawiyat Brak",
        branch_4_desc: "Tytuł: Dom Sędziego Al-Rashida (~1060 AH).",

        branch_5_title: "(5) Al-Athamnah",
        branch_5_subtitle: "Zawiyat Brak",
        branch_5_desc: "Gałęzie: Al-Baradnah (Synowie Badr al-Dina ~1040 AH).",

        branch_6_title: "(6) Dzieci Abdula Wahida",
        branch_6_subtitle: "Zawiyat Brak",
        branch_6_desc: "Gałęzie: Al-Alawneh (~1040 AH).",
        ...
        lib_logic_text:
            "1. <strong>Tytuł:</strong> Jego imię pojawia się w rękopisach jako 'Al-Sulami Al-Ansari'.<br>2. <strong>Pismo:</strong> Stare dokumenty napisane pismem andaluzyjskim.<br>3. <strong>Oś Czasu:</strong> Idealne dopasowanie do exodusu rodzin z Granady.",
    ...
    nodes: [
        ...
        },
        {
            ...
            type: "epoch-4",
            date: "860 - 930 AH (szacunkowo)",
            badge: "Andaluzyjski مهاجر",
            src: "Family documents + Andalusian migration context",
            logic: "Był świadkiem upadku Granady (897 AH) i przeniósł rodzinę do Fezu.",
        ...
        },
        {
            ...
            type: "epoch-5",
            date: "900 - 960 AH (wejście do Fezzanu ~950 AH)",
            badge: "Założyciel wakfu",
            src: "Tarikh Fezzan + waqf documents",
            logic: "Urodzony w Maroku, migrował do Libii około 950 AH i ustanowił wakf.",

window.FamilyTreeData = {
    ...
    translations: {
        ...
        fadl_node: "52. Fadl bin Abdullah<br><span style=\"font-size:0.85rem; font-weight:500;\">(Tahmini: 990 - 1030 H)</span>",
        modern_era_title: "Modern Uzantı (H. 1100 - H. 1447)",
        ...
        branch_1_desc: "Beş Oymak (53-54. Nesil): Savalim, Kadavi, Allavi, Bakur, Vasfa (~H. 1070).",
        ...
        branch_3_desc: "Kollar (53. Nesil): Evlad El-Ahdari, Evlad Yusuf (~H. 1050).",

        branch_4_title: "(4) Kasım Çocukları",
        branch_4_subtitle: "Zaviye Brak",
        branch_4_desc: "Unvan: Kadı El-Raşid Evi (~H. 1060).",

        branch_5_title: "(5) El-Atamne",
        branch_5_subtitle: "Zaviye Brak",
        branch_5_desc: "Kollar: El-Baradne (Bedreddin'in oğulları ~H. 1040).",

        branch_6_title: "(6) Abdulvahid Çocukları",
        branch_6_subtitle: "Zaviye Brak",
        branch_6_desc: "Kollar: El-Alavne (~H. 1040).",
        ...
        lib_logic_text:
            "1. <strong>Unvan:</strong> El yazmalarında adı 'El-Sülemi El-Ensari' olarak geçmektedir.<br>2. <strong>Yazı:</strong> Eski belgeler Endülüs yazısıyla yazılmıştır.<br>3. <strong>Zaman Çizelgesi:</strong> Gırnata ailelerinin göçüyle tam uyum (H. 897 sonrası).",
